...
"""
write_file("apps/mobile/package.json", mobile_package_json)

# 2. apps/mobile/app.json
mobile_app_json = """{
  "expo": {
    "name": "RPS Adaptive AI",
    "slug": "rps-adaptive-ai",
    "version": "1.0.0",
    ...
    "plugins": [
      [
        "expo-camera",
        {
          "cameraPermission": "Allow RPS Adaptive AI to access camera for live hand gesture detection."
        }
      ]
    ]
  }
...
"""
write_file("apps/mobile/app.json", mobile_app_json)
...
"""
write_file("apps/mobile/tsconfig.json", mobile_tsconfig)

# 4. apps/mobile/babel.config.js
mobile_babel = """module.exports = function(api) {
  api.cache(true);
  return {
...
"""
write_file("apps/mobile/babel.config.js", mobile_babel)

# 5. apps/mobile/App.tsx
mobile_app_tsx = """import React, { useState, useRef } from 'react';
import {
  StyleSheet,
  Text,
  View,
...
"""
write_file("apps/mobile/App.tsx", mobile_app_tsx)

print("Mobile app scaffolded successfully!")
